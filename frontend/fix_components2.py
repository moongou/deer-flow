...
match = re.search(r"return \(\n    <div className=\"space-y-4\">\n      <div className=\"flex items-center justify-between\">[\s\S]*?<Badge className=\"ml-2 bg-primary text-primary-foreground text-\[10px\]\">激活</Badge>[\s\S]*?</ScrollArea>\n      \)}\n    </div>\n  \);", content)
if match:
    ...
    print("Could not find OllamaTab return match!")
